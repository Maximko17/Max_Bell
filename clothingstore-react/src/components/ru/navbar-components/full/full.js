...
class Full extends Component {
  ...
  getRemainingMessage = remaining => {
    if (remaining === 0) {
      return <div className="full-remaining grey">Распродано</div>;
    } else if (remaining <= 25) {
      return <div className="full-remaining yellow">Заканчивается</div>;
    } else {
      return <div className="full-remaining green">Есть в наличии</div>;
    }
  };
        ...
        <div className="container full">
          <div className="row justify-content-center">
            ...
            <div className="full-content col-lg ml-3">
              ...
              <div className="full-price">{price} ₽</div>
              <p>
                (
                {`Доставка: по миру - ${worldDelivery} ₽, по России - ${countryDelivery} ₽`}
                )
              </p>
              ...
              <div>
                ...
                >
                  <i className="fas fa-shopping-cart "> Добавить в корзину</i>
                </button>
              </div>
            </div>
          </div>
          <div className="reviews">
            <div className="add-title">
              <div className="d-flex justify-content-between">
                <div style={{ lineHeight: "4", height: "20px" }}>Отзывы</div>
                <button
