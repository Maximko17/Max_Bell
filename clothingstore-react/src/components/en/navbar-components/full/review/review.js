        ...
        <form className="col-lg-7 review-form" onSubmit={this.onSubmit}>
          <div className="add-review-title">
            <input
              ...
              placeholder="Name (Maximum 50 characters)"
            ...
            <span>Enter a title for your review.</span>
          </div>
          <div className="add-review-text">
            <textarea
              ...
              placeholder="Text. (Maximum 250 characters)"
              onChange={this.onReviewChange}
              value={text}
            />
            {errors.text && (
            ...
            <span>Write your opinion about this product.</span>
          </div>
          <div className="rating">
            ...
            />
            <br />
            <div>How would you rate this product?</div>
          </div>
          <div className="add-review-images">
            ...
            <br />
            <span>
              You can also upload your own photo with this product. (Optional)
            </span>
          </div>
          <div id="gallery" />
          <Captcha
          ...
          />
          <span>This is to protect against spam.</span>
          <br />
      ...
      <div>
        {content && content.length === 0 ? (
          <div className="length-null-mess">
            Be the first to who add a review!
          </div>
        ) : null}
