...
class Registration_en extends Component {
  state = {
    customer: {
      firstName: "",
      username: "",
            ...
            <div className="col-lg-7 shadow">
              ...
              <form onSubmit={this.onRegister}>
                ...
                <div className="gender text-center mt-3">
                  <p id="gender-title">Your gender</p>
                  <input
                    type="radio"
                    name="gender"
                    id="man"
                ...
                <div className="photo mt-3 mb-2">
                  <p id="photo-title">Your photo (optional)</p>
                ...
                <div className="login-buttons">
                  ...
                  <Link to={"/en/login"} className="btn btn-outline-danger">
                    Back
                  </Link>
                </div>
              </form>
